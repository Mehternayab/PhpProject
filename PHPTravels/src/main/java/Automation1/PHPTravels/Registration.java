...
public class Registration {
	...
	private By submit = By.xpath("//button[@class='signupbtn btn_full btn btn-action btn-block btn-lg']");
	...
	public void check(WebDriver driver,Properties prop) throws IOException {
		String str = (String)driver.findElement(By.xpath("//h3[@class='RTL']")).getText();
